...
class NestedAlgo(BaseAlgo):
    ...
    def update(self, storage, gild_coef, args=None, beginning=False, t=1,adm_first_freeze=False):
            ...
            if args.freeze_policy:
                ...
                for module in self.modules:
                    if i == 0:
                        ...
                        add_log_vals = module.update(discrim, storage, gild_coef, beginning, t)
                        log_vals = {**log_vals, **add_log_vals}
