...
#     def __init__(self, agent_updater=None, get_discrim=None, state_dim=None, action_dim=None, max_action=None):
#         # 如果没有传入 agent_updater（即默认为 None），则初始化 PPO_GILD
...
#         super().__init__([agent_updater], 0)d
